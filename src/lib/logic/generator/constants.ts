...
export const TILE_RANGE_LIGHTNING_COLLECTOR = 18;
...
export const PIXEL_RANGE_SUBSTATION = Math.floor(TILE_RANGE_SUBSTATION / TILES_PER_PIXEL);
export const PIXEL_RANGE_LIGHTNING_COLLECTOR = Math.floor(
	TILE_RANGE_LIGHTNING_COLLECTOR / TILES_PER_PIXEL
);
export const PIXEL_RANGE_ROBOPORT = Math.floor(TILE_RANGE_ROBOPORT / TILES_PER_PIXEL);
...
export const PIXEL_RADIUS_LIGHTNING_COLLECTOR = Math.round(PIXEL_RANGE_LIGHTNING_COLLECTOR / 2);
...
export const SE_PIXEL_RANGE_RADAR_PYLON = SE_TILE_RANGE_RADAR_PYLON / SE_TILES_PER_PIXEL;
export const SE_PIXEL_RANGE_POWER_PYLON = SE_TILE_RANGE_POWER_PYLON / SE_TILES_PER_PIXEL;
export const SE_PIXEL_RANGE_SUPERCHARGER = SE_TILE_RANGE_SUPERCHARGER / SE_TILES_PER_PIXEL;

export const SE_PIXEL_RADIUS_RADAR_PYLON = Math.floor(SE_PIXEL_RANGE_RADAR_PYLON / 2);
export const SE_PIXEL_RADIUS_POWER_PYLON = Math.floor(SE_PIXEL_RANGE_POWER_PYLON / 2);
export const SE_PIXEL_RADIUS_SUPERCHARGER = Math.floor(SE_PIXEL_RANGE_SUPERCHARGER / 2);
